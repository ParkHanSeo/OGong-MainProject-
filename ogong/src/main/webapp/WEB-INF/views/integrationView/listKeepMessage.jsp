...
body, table, div, p, th, td {
	...
	$(function(){
		...
		$("#updateReceiveMassage").on("click", function(){
			...
			var messageArr = new Array();
		 	 ...
		 	 $.ajax({
		 		 	 url : "/integration/updateReceiveMessage",
		 		 	 type : "POST",
            ...
            <div class="card-body p-0">
              <div class="mailbox-controls">
                ...
                <div class="btn-group float-left">
                  ...
                  <button type="button" class="btn btn-default btn-sm" id="updateReceiveMassage" name="updateReceiveMassage">
                    <a>취소</a>
                  </button>                    
